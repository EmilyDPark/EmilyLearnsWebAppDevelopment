...
namespace EmilyLearnsWebAppDevelopment.Filters // No need to log everything
{
    //public class CityLogActionFilterAttribute : ActionFilterAttribute
    //{
    ...
    //    public CityLogActionFilterAttribute(IWebHostEnvironment environment)
    //    {
